...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    if (section && heading && subheading && cta && image) {
      ...
      tl.fromTo(heading, { y: 50, opacity: 0 }, { y: 0, opacity: 1, duration: 1 })
        .fromTo(subheading, { y: 50, opacity: 0 }, { y: 0, opacity: 1, duration: 1 }, "-=0.8")
        .fromTo(cta, { y: 50, opacity: 0 }, { y: 0, opacity: 1, duration: 1 }, "-=0.8")
        .fromTo(image, { x: 100, opacity: 0 }, { x: 0, opacity: 1, duration: 1.2 }, "-=1")
    }
  }, [])
  ...
  return (
    <section id="home" ref={sectionRef} className="min-h-screen flex items-center pt-20 pb-10">
